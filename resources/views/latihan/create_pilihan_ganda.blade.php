            ...
            <div class="px-8 pt-4 pb-2 flex-1 flex flex-col">
                <header class="pl-3 pb-2">
                    <div class="flex items-center gap-4 h-10 text-[13px] text-[#98A2B3]">
                        ...
                        <span>&rsaquo;</span>
                        <span class="text-blue-600 font-medium">Tambah Soal</span>
                    </div>
                </header>
                ...
                <main
                    ...
                    <div class="pb-2">
                        <h1 class="text-xl font-bold text-gray-900 tracking-tight">Tambah Soal Pilihan Ganda</h1>
                    </div>

                    @if ($errors->any())
                        <div class="bg-red-50 text-red-600 p-4 rounded-xl text-xs space-y-1 border border-red-100">
                            <p class="font-bold">Gagal menyimpan soal. Silakan periksa kembali:</p>
                    ...
                    <form action="{{ route('latihan.exam.store_pilihan_ganda', $latihan->id) }}" method="POST"
                        class="space-y-5">
                        @csrf
                        ...
                        <div class="space-y-2">
                            ...
                            <div
                                ...
                                <textarea name="optional_feedback" placeholder="Type here..." rows="12"
                                    class="w-full p-4 text-xs bg-white border-none resize-none placeholder-gray-400 text-gray-600 focus:outline-none focus:ring-0 focus:border-transparent shadow-none"></textarea>
                            </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                <select name="tingkat_kesulitan"
                                    ...
                                    <option value="1" {{ old('tingkat_kesulitan') == '1' ? 'selected' : '' }}>Mudah</option>
                                    <option value="2" {{ old('tingkat_kesulitan') == '2' ? 'selected' : '' }}>Sedang</option>
                                    <option value="3" {{ old('tingkat_kesulitan') == '3' ? 'selected' : '' }}>Sangat Sulit</option>
                                </select>
                                <div
                        ...
                        <div class="space-y-3 pt-4">
                            ...
                            <div class="border border-[#E4E7EC] rounded-2xl overflow-hidden bg-white">
                                ...
                                {{-- HEADER TABEL - diperbaiki agar sejajar dengan baris data --}}
                                <div class="grid grid-cols-12 h-[60px] px-4 bg-[#F5FAFF] border-b border-[#E4E7EC]">

                                    {{-- Benar: flex justify-center agar sejajar dengan radio button di tengah --}}
                                    <div class="col-span-1 flex items-center justify-center text-[14px] font-medium text-[#2E90FA]">
                                        Benar
                                    </div>

                                    {{-- Jawaban: tambah px-2 agar sejajar dengan input yang punya px-2 --}}
                                    <div class="col-span-5 flex items-center px-2 text-[14px] font-medium text-[#2E90FA]">
                                        Jawaban
                                    </div>

                                    {{-- Komentar: tambah px-2 agar sejajar dengan input yang punya px-2 --}}
                                    <div class="col-span-4 flex items-center px-2 text-[14px] font-medium text-[#2E90FA]">
                                        Komentar
                                    </div>

                                    {{-- Nilai: justify-center agar sejajar dengan input yang di-center --}}
                                    <div class="col-span-1 flex items-center justify-center text-[14px] font-medium text-[#2E90FA]">
                                        Nilai
                                    </div>

                                    {{-- Aksi: justify-center agar sejajar dengan tombol hapus --}}
                                    <div class="col-span-1 flex items-center justify-center text-[14px] font-medium text-[#2E90FA]">
                                        Aksi
                                    </div>
                                ...
                                <div class="divide-y divide-gray-100 bg-white">
                                    ...
                                    <div class="grid grid-cols-12 items-center py-3.5 px-4 group">
                                        ...
                                        <div class="col-span-4 px-2">
                                            <input type="text" name="komentar_a" value="{{ old('komentar_a') }}"
                                                placeholder="Komentar opsional opsi A"
                                                class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm bg-white focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition placeholder-gray-300 text-gray-700">
                                        </div>
                                        <div class="col-span-1 flex justify-center">
                                            <input type="number" name="nilai_a" value="{{ old('nilai_a', 5) }}"
                                    ...
                                    <div class="grid grid-cols-12 items-center py-3.5 px-4 group">
                                        ...
                                        <div class="col-span-5 px-2">
                                            <input type="text" name="opsi_b" value="{{ old('opsi_b') }}"
                                                placeholder="Opsi B"
                                                class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm bg-white focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition placeholder-gray-300 text-gray-700"
                                                required>
                                        </div>
                                        <div class="col-span-4 px-2">
                                            <input type="text" name="komentar_b" value="{{ old('komentar_b') }}"
                                                placeholder="Komentar opsional opsi B"
                                                class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm bg-white focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition placeholder-gray-300 text-gray-700">
                                        </div>
                                        <div class="col-span-1 flex justify-center">
                                            <input type="number" name="nilai_b" value="{{ old('nilai_b', -1) }}"
                                                class="w-14 border border-gray-200 rounded-xl py-2.5 text-center text-sm focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition text-gray-600 font-medium">
                                        </div>
                                        <div class="col-span-1 flex justify-center">
                                            <button type="button"
                                    ...
                                    <div class="grid grid-cols-12 items-center py-3.5 px-4 group">
                                        ...
                                        <div class="col-span-5 px-2">
                                            <input type="text" name="opsi_c" value="{{ old('opsi_c') }}"
                                                placeholder="Opsi C"
                                                class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm bg-white focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition placeholder-gray-300 text-gray-700"
                                                required>
                                        </div>
                                        <div class="col-span-4 px-2">
                                            <input type="text" name="komentar_c" value="{{ old('komentar_c') }}"
                                                placeholder="Komentar opsional opsi C"
                                                class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm bg-white focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition placeholder-gray-300 text-gray-700">
                                        </div>
                                        <div class="col-span-1 flex justify-center">
                                            <input type="number" name="nilai_c" value="{{ old('nilai_c', -1) }}"
                                                class="w-14 border border-gray-200 rounded-xl py-2.5 text-center text-sm focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition text-gray-600 font-medium">
                                        </div>
                                        <div class="col-span-1 flex justify-center">
                                            <button type="button"
                                    ...
                                    <div class="grid grid-cols-12 items-center py-3.5 px-4 group">
                                        ...
                                        <div class="col-span-5 px-2">
                                            <input type="text" name="opsi_d" value="{{ old('opsi_d') }}"
                                                placeholder="Opsi D"
                                                class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm bg-white focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition placeholder-gray-300 text-gray-700"
                                                required>
                                        </div>
                                        <div class="col-span-4 px-2">
                                            <input type="text" name="komentar_d" value="{{ old('komentar_d') }}"
                                                placeholder="Komentar opsional opsi D"
                                                class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm bg-white focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition placeholder-gray-300 text-gray-700">
                                        </div>
                                        <div class="col-span-1 flex justify-center">
                                            <input type="number" name="nilai_d" value="{{ old('nilai_d', -1) }}"
                                                class="w-14 border border-gray-200 rounded-xl py-2.5 text-center text-sm focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition text-gray-600 font-medium">
                                        </div>
                                        <div class="col-span-1 flex justify-center">
                                            <button type="button"
