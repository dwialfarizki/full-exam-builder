<x-app-layout>
    <div class="flex min-h-screen bg-gray-50 text-gray-700 font-sans">
                ...
                <div x-data="{ open: true }">
                    ...
                    <div x-show="open" class="border-l border-gray-200 ml-8 my-1 space-y-0.5">
                        <div class="relative -ml-[1px] border-l border-transparent">
                            <a href="{{ route('latihan.index') }}" class="block pl-5 py-2 text-gray-500 hover:text-gray-900 transition-colors">
                                Mata Kuliah Saya
                            </a>
                        </div>
                        <div class="relative -ml-[1px] border-l border-transparent">
        ...
        <div class="flex-1 flex flex-col min-w-0">
            ...
            <footer
                class="bg-white border-t border-gray-200 px-6 py-4 flex flex-col sm:flex-row justify-between items-center gap-2 text-[11px] text-gray-400">
                <div class="flex items-center gap-[10px]">
                    <a href="{{ route('dashboard') }}" class="flex items-center">
                        <img src="{{ asset('images/Logo.svg') }}" alt="Smart Exam"
                            class="w-[54px] h-[32px] object-contain">
                    </a>
                    <span>&copy; 2026 Smart Exam | All rights reserved.</span>
                </div>
                <div class="flex space-x-4">
                    <a href="#" class="hover:text-gray-600">Cara Kerja</a>
                    <a href="#" class="hover:text-gray-600">Pusat Bantuan</a>
                    <a href="#" class="hover:text-gray-600">Hubungi Kami</a>
                </div>
            </footer>
        </div>
    </div>
